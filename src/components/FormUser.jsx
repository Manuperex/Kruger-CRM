...
const FormUser = ({ employeeUser, editing }) => {
    ...
    <>
      ...
      <div className="mb-4">
        ...
        <input
          ...
          name="lastName"
          defaultValue={employeeUser?.lastName}
        />
      </div>
      ...
      <div className="mb-4">
        ...
        <input
          ...
          defaultValue={employeeUser?.identificationCard}
        />
      </div>
      {editing === true ? (
        <div>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              name="address"
              defaultValue="Dirección de domicilio"
            />
          </div>
          <div className="mb-4">
          ...
          {stateVacunation === "vacunado" ? (
            <div>
              <div className="mb-4">
                <label>
                  Tipo de vacunacion:{" "}
                  <select name="vacunacionTipe" defaultValue="Sputnik">
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  defaultValue="Fecha de vacunación"
                />
              </div>
              <div className="mb-4">
                <label>
                  Número de dosis:{" "}
                  <select name="numberDoses" defaultValue="Una Dosis">
